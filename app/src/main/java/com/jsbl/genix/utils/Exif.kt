    ...
    fun getOrientation(jpeg: ByteArray?): Int {
        ...
        if (length > 8) {
            ...
            if (tag != 0x49492A00 && tag != 0x4D4D002A) {
                logD(APP_TAG,  "Invalid byte order")
                return 0
            }
            ...
            while (count-- > 0 && length >= 12) {
                ...
                if (tag == 0x0112) {
                    ...
                    logD(APP_TAG,  "Unsupported orientation")
                    return 0
                }
                offset += 12
                length -= 12
        ...
        logD(APP_TAG, "Orientation not found")
        return 0
    }
